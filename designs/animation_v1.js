var animate1 = {
  ...
  Init: function() {
		...
		animate1.canvas = document.getElementById('animation'); //document.querySelector('canvas');
    animate1.ctx = animate1.canvas.getContext('2d');

		animate1.density = 2050;
		animate1.noise = 127;
	  animate1.speed = 0.74;
	  animate1.color = { bg: 'black', ink: '#F9DC5C' };
    ...
    animate1.canvas.width = window.innerWidth > window.innerHeight ? window.innerHeight : window.innerWidth;
...
window.addEventListener('reload', function(){animate1.Init();});
